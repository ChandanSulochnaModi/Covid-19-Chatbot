# End-to-End Covid-19 chatbot using DialogFlow,Python/Flask,MongoDb Atlas.
...
1). Show you statistics based on Country,Indian States,Indian districts,Google Maps,WorldWide
